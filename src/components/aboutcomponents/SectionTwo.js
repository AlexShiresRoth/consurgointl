  ...
  return (
    <div className={layoutStyles.container__columns}>
      ...
      <div className={layoutStyles.column}>
        ...
        <p>
          For the International customer we provide quick and economic access to
          US products, such as process control instruments, gaming equipment,
          and a wide range of food items through our vast network of supply
          chains. We serve as a buying and logistics office inside the US.
        </p>
        <p>
          For US manufacturer's we provide a value added service by providing a
          quick access to foreign markets regardless of the size and scope of
          the transaction. We eliminate all risks associated with selling the
          product overseas. We handle all of the technical, financial and
